...
<div class='panel panel-default card'><div class='panel-heading card-header'>
        <span id="capc_label_<?php echo $package['ID']; ?>"><?=esc_attr__("Verify CAPTCHA to Download", "download-manager"); ?></span>
...
<script type="text/javascript">
    ...
    var verifyCallback_<?php echo $package['ID']; ?> = function(response) {
        jQuery.post("<?php echo wpdm_rest_url('validate-password'); ?>",{__wpdm_ID:<?php echo $package['ID'];?>,dataType:'json',execute:'wpdm_getlink',force:force,social:'c',reCaptchaVerify:response,action:'wpdm_ajax_call'},function(res){
