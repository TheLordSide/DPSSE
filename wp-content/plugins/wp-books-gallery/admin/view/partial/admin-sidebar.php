...
?>
<div class="wbg-admin-sidebar" style="width: 20%; float: left;">
    <div class="postbox pro-features">
        <h3 class="hndle"><span>Pro Features</span></h3>
        <div class="inside centered">
            <ul>
                <li>&#10003; Display Unlimited Books</li>
                <li>
                    <a href="https://books-gallery.com/docs/import-books-from-open-library/" target="_blank">&#10003; Import Books From Open Library &#128279;</a>
                </li>
                <li>
                    <a href="https://books-gallery.com/docs/import-books-from-csv/" target="_blank">&#10003; Import Books via Csv &#128279;</a>
                </li>
                <li>&#10003; Books Review & Rating</li>
                <li>&#10003; 10 Additional Sources to Sell Your Books</li>
                <li>&#10003; Display Featured Books With Slider</li>
            ...
            <p style="margin-bottom: 1px! important;"><a href="https://books-gallery.com/pricing-faq/" target="_blank" class="button button-primary wbg-button" style="background: #F5653E;">Upgrade Now!</a></p>
        </div>
    </div>
    <div class="postbox">
        ...
        <div class="inside centered">
            ...
            <p style="margin-bottom: 1px! important;"><a href="https://books-gallery.com/" target="_blank" class="button button-primary wbg-button">Get Support</a></p>
        </div>
    </div>
    <div class="postbox">
        <h3 class="hndle"><span>Join Us</span></h3>
        <div class="inside centered">
