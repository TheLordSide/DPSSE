...
$output .= '<div class="gs-row clearfix gs_bookshowcase" id="gs_bookshowcase'.get_the_id().'">';
    ...
    if ( $GLOBALS['gs_bookshowcase_loop']->have_posts() ) {
        while ( $GLOBALS['gs_bookshowcase_loop']->have_posts() ) {
            ...
            $gsbks_book_desc            = strip_tags( get_the_content() );
            ...
            $output .= '<div class="col-md-'.$cols.' col-sm-6 col-xs-6">';
                ...
                $output .= '<div class="single-book text-center">'; // start single book
                    ...
                    $output .= '<div class="single-book-desc-info">'; // start desc & info text
                        ...
                        $output .= '<div class="gs-bookshowcase-info text-center">';
                ...
                $output .= '</div>'; // end single book
                    ...
                    if ( !empty( $gsbks_book_title ) && 'on' ==  $gsbks_op_book_title ) :
                        $output.= '<div class="gs-book-name text-center">'. $gsbks_book_title .'</div>';
                    endif;
            $output .= '</div>'; // end col
