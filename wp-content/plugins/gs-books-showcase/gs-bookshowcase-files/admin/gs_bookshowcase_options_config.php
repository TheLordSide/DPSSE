        ...
        $settings_fields = array(
            ...
            'gs_bookshowcase_settings' => array(
                ...
                array(
                    ...
                    'desc'  => __( 'Select preferred Style & Theme', 'gsbookshowcase' ),
                    'type'  => 'select',
                ...
                array(
                    ...
                    'label' => __( 'Description Character control', 'gsbookshowcase' ),
                    'desc'  => __( 'Set max no of characters in Book details. Default 100 & Max 300', 'gsbookshowcase' ),
                    'type'  => 'number',
                    'min'   => 1,
                    'max'   => 300,
                    'default' => 100
            ...
            'gs_bookshowcase_style_settings' => array(
                array(
                    ...
                    'desc'      => __( '<p class="gsbookshowcase_pro">Available at <a href="https://www.gsplugins.com/product/wordpress-books-showcase-plugin/" target="_blank">PRO</a> version.</p>', 'gsbookshowcase' )
                ),
                // Font Size
                array(
                    'name'      => 'gs_book_fz',
...
$gs_settings = new gs_Bookshowcase_Settings_Config();