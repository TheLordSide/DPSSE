...
if( ! class_exists( 'GSPlugins_bookshowcase_free' ) ){
    
    class GSPlugins_bookshowcase_free{
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof GSPlugins_bookshowcase_free ) {
                self::$_instance = new GSPlugins_bookshowcase_free();
            }
    ...
    $gsplugin_free = GSPlugins_bookshowcase_free::get_instance();
}