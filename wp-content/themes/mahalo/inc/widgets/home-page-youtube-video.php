...
if (!function_exists('mahalo_youtube_video_slider')):
    ...
    function mahalo_youtube_video_slider()
    {
        ...
        // Video Post widget.
        register_widget('Mahalo_youptube_Video_Slider');

    }
endif;
add_action('widgets_init', 'mahalo_youtube_video_slider');
/*Video widget*/
if (!class_exists('Mahalo_youptube_Video_Slider')):
     ...
     * @since 1.0.0
     */
    class Mahalo_youptube_Video_Slider extends Mahalo_Widget_Base
    {
