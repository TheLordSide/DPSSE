<?php
/**
 * Article Carousel Widget Style
 *
 * @package Mahalo
 */
if (!function_exists('mahalo_post_carousel_widget')) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function mahalo_post_carousel_widget()
    {
        register_widget('Mahalo_Post_Carousel_Widget');
    }
endif;
add_action('widgets_init', 'mahalo_post_carousel_widget');
// Article Widget Carousel Layout
if (!class_exists('Mahalo_Post_Carousel_Widget')) :
    /**
     * Article Widget Carousel Layout
     *
     * @since 1.0.0
     */
    class Mahalo_Post_Carousel_Widget extends Mahalo_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'mahalo_post_carousel_widget',
                'description' => esc_html__('Displays post form selected category in carousel styles', 'mahalo'),
            ...
            parent::__construct('mahalo-widget-carousel-style', esc_html__('Mahalo: Carousel Widget', 'mahalo'), $opts, array(), $fields);
        }
        ...
        function widget($args, $instance)
        {
            ...
            if ($style_1_posts_query->have_posts()) : ?>
                <div class="widget-layout widget-layout-carousel">
                    ...
                    <div class="wrapper slick-widget-wrapper">
                        <div class="theme-widget-carousel" data-slick='{"rtl": <?php echo esc_attr($rtl); ?>}'>
                            <?php
