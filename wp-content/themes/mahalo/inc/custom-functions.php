...
if( !function_exists('mahalo_theme_navextras') ):
    ...
    function mahalo_theme_navextras(){
        ...
        $mahalo_default = mahalo_get_default_theme_options();
        $ed_ticker_bar = get_theme_mod( 'ed_ticker_bar', $mahalo_default['ed_ticker_bar'] );
...
if( !function_exists('mahalo_top_header_render') ):
    ...
    function mahalo_top_header_render( $render = true ){
        ...
        $mahalo_default = mahalo_get_default_theme_options();
        $ed_ticker_bar = get_theme_mod( 'ed_ticker_bar', $mahalo_default['ed_ticker_bar'] );
        $ed_ticker_bar_date = get_theme_mod( 'ed_ticker_bar_date', $mahalo_default['ed_ticker_bar_date'] );
        $ed_ticker_bar_time = get_theme_mod( 'ed_ticker_bar_time', $mahalo_default['ed_ticker_bar_time'] );
        $ticker_date_format = get_theme_mod( 'ticker_date_format', $mahalo_default['ticker_date_format'] );
        $ed_ticker_bar_social_nav = get_theme_mod( 'ed_ticker_bar_social_nav', $mahalo_default['ed_ticker_bar_social_nav'] );

        if( $ed_ticker_bar && ( has_nav_menu('mahalo-social-menu') || $ed_ticker_bar_date ) ){ ?>
            ...
            <div class="wrapper-fluid header-wrapper">
                    ...
                    if ($ed_ticker_bar_date) {
                     ?>
                        <div class="header-topbar-item header-topbar-date">
                            <span class="header-topbar-icon"><?php mahalo_theme_svg('calendar-full'); ?></span>
                            <span class="header-topbar-label"><?php echo esc_html(date( esc_attr($ticker_date_format))); ?></span>
                        </div>
                    <?php } ?>
                    <?php
                    if ($ed_ticker_bar_time) {
                     ?>
                    <div class="header-topbar-item header-topbar-clock">
                        <span class="header-topbar-icon"><?php mahalo_theme_svg('clock'); ?></span>
                ...
                <div class="header-item header-item-right">
                    <?php
                    if (has_nav_menu('mahalo-social-menu') && $ed_ticker_bar_social_nav) { ?>
...
if( !function_exists( 'mahalo_header_ticker_posts' ) ):
    ...
    function mahalo_header_ticker_posts(){
        ...
        $slider_autoplay = get_theme_mod( 'ed_ticker_slider_autoplay',$mahalo_default['ed_ticker_slider_autoplay'] );
