...
$wp_customize->add_setting('ed_ticker_slider_autoplay',
    array(
        'default' => $mahalo_default['ed_ticker_slider_autoplay'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'mahalo_sanitize_checkbox',
    )
);
$wp_customize->add_control('ed_ticker_slider_autoplay',
    array(
        'label' => esc_html__('Enable Ticker Posts Autoplay', 'mahalo'),
        'section' => 'breaking_news_setting',
        'type' => 'checkbox',
    )
);
...
$wp_customize->add_setting('ed_ticker_bar',
    array(
        'default' => $mahalo_default['ed_ticker_bar'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'mahalo_sanitize_checkbox',
    )
);
$wp_customize->add_control('ed_ticker_bar',
    array(
        'label' => esc_html__('Enable Ticker Bar', 'mahalo'),
...
$wp_customize->add_setting('ed_ticker_bar_social_nav',
    array(
        'default' => $mahalo_default['ed_ticker_bar_social_nav'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'mahalo_sanitize_checkbox',
    )
);
...
$wp_customize->add_setting('ed_ticker_bar_date',
    array(
        'default' => $mahalo_default['ed_ticker_bar_date'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'mahalo_sanitize_checkbox',
    )
);
...
$wp_customize->add_setting('ed_ticker_bar_time',
    array(
        'default' => $mahalo_default['ed_ticker_bar_time'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'mahalo_sanitize_checkbox',
    )
);
